...
export interface InitOutput {
    ...
    readonly main: () => void;
    readonly wasm_bindgen__closure__destroy__hf9f5c34b4ac28ae4: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__hc6b8fa45a19d778b: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h13779d8d00cafc07: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hc9f5d663b18c1ea0: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h509187a2ae7c6be3: (a: number, b: number) => void;
