...
export interface InitOutput {
    ...
    readonly main: () => void;
    readonly wasm_bindgen__closure__destroy__h5b76e84ca8331863: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h8dbb6f3133f84fd9: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hd84563e8d4121d27: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h7cfa74838488001a: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__ha0b99322486a24bc: (a: number, b: number) => void;
