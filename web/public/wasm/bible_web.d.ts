...
export interface InitOutput {
    ...
    readonly main: () => void;
    readonly wasm_bindgen__closure__destroy__h8adf60a90a9a2f69: (a: number, b: number) => void;
    readonly wasm_bindgen__closure__destroy__h83bd2d8a6e84c24c: (a: number, b: number) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h5e89df7492a86612: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h1321ee283d4bb411: (a: number, b: number, c: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__hfb7e522699527b75: (a: number, b: number) => void;
